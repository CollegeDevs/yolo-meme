...
ActiveRecord::Schema.define(version: 20150305123226) do
  ...
  create_table "procats", force: true do |t|
    t.integer  "project_id"
  ...
  add_index "procats", ["category_id"], name: "index_procats_on_category_id"
  add_index "procats", ["project_id"], name: "index_procats_on_project_id"
